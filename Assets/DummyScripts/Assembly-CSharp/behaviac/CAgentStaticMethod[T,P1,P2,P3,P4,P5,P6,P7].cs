...
namespace behaviac
{
	public class CAgentStaticMethod<T, P1, P2, P3, P4, P5, P6, P7> : CAgentMethodBase<T> // TypeDefIndex: 27286
	{
		// Fields
		...
		// Nested types
		public delegate T FunctionPointer(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7); // TypeDefIndex: 27287; 0x00000000-0x00000000
