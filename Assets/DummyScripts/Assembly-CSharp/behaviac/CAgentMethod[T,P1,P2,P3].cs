...
namespace behaviac
{
	public class CAgentMethod<T, P1, P2, P3> : CAgentMethodBase<T> // TypeDefIndex: 27248
	{
		// Fields
		...
		// Nested types
		public delegate T FunctionPointer(Agent a, P1 p1, P2 p2, P3 p3); // TypeDefIndex: 27249; 0x00000000-0x00000000
