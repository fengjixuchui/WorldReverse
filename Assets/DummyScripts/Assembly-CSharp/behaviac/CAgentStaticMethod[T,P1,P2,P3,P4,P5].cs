...
namespace behaviac
{
	public class CAgentStaticMethod<T, P1, P2, P3, P4, P5> : CAgentMethodBase<T> // TypeDefIndex: 27282
	{
		// Fields
		...
		// Nested types
		public delegate T FunctionPointer(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5); // TypeDefIndex: 27283; 0x00000000-0x00000000
