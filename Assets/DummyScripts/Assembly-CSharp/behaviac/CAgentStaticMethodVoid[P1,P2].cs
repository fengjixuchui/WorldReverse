...
namespace behaviac
{
	public class CAgentStaticMethodVoid<P1, P2> : CAgentMethodVoidBase // TypeDefIndex: 27337
	{
		// Fields
		...
		// Nested types
		public delegate void FunctionPointer(P1 p1, P2 p2); // TypeDefIndex: 27338; 0x00000000-0x00000000
