...
namespace behaviac
{
	public class CAgentStaticMethodVoid<P1, P2, P3, P4, P5> : CAgentMethodVoidBase // TypeDefIndex: 27343
	{
		// Fields
		...
		// Nested types
		public delegate void FunctionPointer(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5); // TypeDefIndex: 27344; 0x00000000-0x00000000
