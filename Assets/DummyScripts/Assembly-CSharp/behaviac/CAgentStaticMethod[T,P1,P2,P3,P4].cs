...
namespace behaviac
{
	public class CAgentStaticMethod<T, P1, P2, P3, P4> : CAgentMethodBase<T> // TypeDefIndex: 27280
	{
		// Fields
		...
		// Nested types
		public delegate T FunctionPointer(P1 p1, P2 p2, P3 p3, P4 p4); // TypeDefIndex: 27281; 0x00000000-0x00000000
