...
namespace behaviac
{
	public class CAgentMethod<T, P1> : CAgentMethodBase<T> // TypeDefIndex: 27244
	{
		// Fields
		...
		// Nested types
		public delegate T FunctionPointer(Agent a, P1 p1); // TypeDefIndex: 27245; 0x00000000-0x00000000
