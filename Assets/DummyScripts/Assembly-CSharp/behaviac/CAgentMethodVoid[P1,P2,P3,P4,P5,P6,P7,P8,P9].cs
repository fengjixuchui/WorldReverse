...
namespace behaviac
{
	public class CAgentMethodVoid<P1, P2, P3, P4, P5, P6, P7, P8, P9> : CAgentMethodVoidBase // TypeDefIndex: 27321
	{
		// Fields
		...
		// Nested types
		public delegate void FunctionPointer(Agent a, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9); // TypeDefIndex: 27322; 0x00000000-0x00000000
