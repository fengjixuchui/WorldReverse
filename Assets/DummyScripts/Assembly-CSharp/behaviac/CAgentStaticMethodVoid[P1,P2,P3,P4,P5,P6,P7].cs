...
namespace behaviac
{
	public class CAgentStaticMethodVoid<P1, P2, P3, P4, P5, P6, P7> : CAgentMethodVoidBase // TypeDefIndex: 27347
	{
		// Fields
		...
		// Nested types
		public delegate void FunctionPointer(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7); // TypeDefIndex: 27348; 0x00000000-0x00000000
