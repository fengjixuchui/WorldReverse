...
{
	[Serializable]
	public struct Tuple<T1, T2, T3, T4, T5, T6, T7> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple // TypeDefIndex: 10652
	{
		// Fields
		private T1 item1;
		private T2 item2;
		...
		public T7 Item7 { get => default; }
	
		// Constructors
		public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7) : this() {
			this.item1 = default;
			this.item2 = default;
			this.item3 = default;
			this.item4 = default;
