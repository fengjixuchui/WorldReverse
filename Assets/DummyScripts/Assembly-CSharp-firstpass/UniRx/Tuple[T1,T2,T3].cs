...
{
	[Serializable]
	public struct Tuple<T1, T2, T3> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple // TypeDefIndex: 10648
	{
		// Fields
		private T1 item1;
		private T2 item2;
		...
		// Constructors
		public Tuple(T1 item1, T2 item2, T3 item3) : this() {
			this.item1 = default;
			this.item2 = default;
			this.item3 = default;
		}
