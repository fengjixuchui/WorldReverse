...
{
	[Serializable]
	public struct Tuple<T1, T2, T3, T4, T5> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple // TypeDefIndex: 10650
	{
		// Fields
		private T1 item1;
		private T2 item2;
		...
		// Constructors
		public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5) : this() {
			this.item1 = default;
			this.item2 = default;
			this.item3 = default;
			this.item4 = default;
