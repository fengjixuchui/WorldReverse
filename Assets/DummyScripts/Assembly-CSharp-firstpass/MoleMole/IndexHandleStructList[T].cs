...
namespace MoleMole
{
	public class IndexHandleStructList<T> : IIndexHandleList<T> // TypeDefIndex: 10569
		where T : struct, IEquatable<T>
	{
		// Fields
		private const int DefaultCapacity = 7; // Metadata: 0x00AE7B6C
		private const int MaxCapacity = 2146435071; // Metadata: 0x00AE7B70
		private const float CapacityFactor = 1.6f; // Metadata: 0x00AE7B74
		...
		// Nested types
		public struct Enumerator : IEnumerator<T> // TypeDefIndex: 10570
		{
			// Fields
			private IndexHandleStructList<T> list;
			private int index;
			private T current;
			...
			// Constructors
			public Enumerator(IndexHandleStructList<T> list) : this() {
				this.list = default;
				index = default;
				current = default;
			}
		...
		// Constructors
		public IndexHandleStructList() {}
		public IndexHandleStructList(int capacity) {}
		...
		public int IndexAdd(T item, bool needToNewArray) => default;
